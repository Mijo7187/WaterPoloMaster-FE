...
class PaginationStore {
  params: Record<PaginationEnum, IGetPagination> = {
    ...
    [PaginationEnum.CONTRACT_PAGINATION]: PAGINATION_INITIAL_STATE,
    [PaginationEnum.CONTRACT_INSTALLMENT_PAGINATION]: PAGINATION_INITIAL_STATE,
    [PaginationEnum.SEASON_PAGINATION]: PAGINATION_INITIAL_STATE,
    [PaginationEnum.MEMBERSHIP_PAGINATION]: PAGINATION_INITIAL_STATE,
  };
